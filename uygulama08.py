...
class Kutuphane:
    def __init__(self, anasayfa):
        ...
        self.kitapları_listele = Button(anasayfa, text="Kitapları Listele", bg="white", fg="red", cursor="star",
                                        font="bold", command=self.kitaplari_listele)
        self.kitapları_listele.grid(row="1")

        self.kitap_ekle = Button(anasayfa, text="Kitap Ekle", bg="white", fg="red", cursor="star", font="bold",
                                 command=self.kitap_ekle)
        self.kitap_ekle.grid(row="2")

        self.kitap_ara = Button(anasayfa, text="Kitap Ara", bg="white", fg="red", cursor="star", font="bold",
